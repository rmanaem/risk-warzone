...
int main(){
    ...
    //Create vectors of unattackable players for each player
    vector<Player *> unAtt1;
    vector<Player *> unAtt2;
    vector<Player *> unAtt3;

    //Create the different types of strategies
    ...
    cout << "Player 1 Orders: " << endl << *(p1->getOrders()) << endl;
    ...
    cout << "Player 2 Orders: " << endl << *(p2->getOrders()) << endl;
    ...
    cout << "Player 3 Orders: " << endl << *(p3->getOrders()) << endl;

    // Show the strategy can be changed midgame
    p1->setStrategy(humanStrat);
    // Show the list of orders chosen by the human player
    p1->issueOrder(validMap, x);
    cout << "Player 1 Orders after changing strategy to human: " << endl << *(p1->getOrders()) << endl;

    // Prevent memory leaks
    delete validMap;
    delete venzuela; delete argentina; delete brazil; delete peru; delete northAfrica; delete eastAfrica;
    delete southAfrica; delete egypt; delete congo; delete mdagascar;
    delete ol1; delete ol2; delete ol3;
    delete humanStrat; delete neutralStrat; delete benevolantStrat; delete aggressiveStrat;
    delete x;
